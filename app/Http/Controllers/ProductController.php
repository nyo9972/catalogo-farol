...
class ProductController extends Controller
{
	...
	public function store(Request $request)
	{
		...
		if(!$validator->fails())
		{
			...
			return redirect('products')
					->with('successMsg', $request->input('name').' foi criado com sucesso em: '.$catTitles);
		} else {
			return redirect()
				->back()
	...
	public function update(Request $request, $id)
	{
		...
		if(!$validator->fails())
		{
			...
			return redirect('products')
					->with('successMsg', $request->input('name').' foi editado com sucesso.');
	...
	public function destroy($id)
	{
		...
		return redirect('products')->with('successMsg', $product->name.' foi excluído com sucesso.');
	}
}
