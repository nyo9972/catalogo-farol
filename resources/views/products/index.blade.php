		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="panel panel-default">
				...
				@if(Auth::user()->role_id == 1)
					<a href="{{ route('products.create') }}" class="btn btn-xs btn-success">&nbsp;&nbsp;Adicionar&nbsp;&nbsp;</a>
				@endif
				</div>
				<div class="panel-body">
					<div class="col-xs-offset-8 col-xs-4" style="margin-bottom: 15px;">
						<form id="filter" action="{{route('products.index')}}" method="get">{!! csrf_field() !!}<select name="filter[]" data-placeholder="Filtrar Por Categorias" class="form-control multiselect" multiple="multiple">
					...
					<table class="table table-hover table-condensed">
						<thead>
							<tr>
								...
								<th class="col-md-2">Categoria(as)</th>
								@if(Auth::user()->role_id == 1)
							...
							<tr>
								...
								<td class="text-center">
									<form class="form-inline">
										<a href="{{ route('products.edit', ['products' => $product->id]) }}" class="btn btn-xs btn-warning" data-toggle="tooltip" data-placement="top" title="Editar">
											<span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
										</a>
										<a href="{{ route('products.destroy', ['products' => $product->id]) }}" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" data-delete="{{ csrf_token() }}" title="Apagar">
